...
public class SeedData
{
    public static async void EnsureSeedData(WebApplication app)
    {
        using (var scope = app.Services.GetRequiredService<IServiceScopeFactory>().CreateScope())
        {
            ...
            await scope.ServiceProvider.GetService<IdentityServerDbContext>().Database.MigrateAsync();
            var initialiser = scope.ServiceProvider.GetRequiredService<IdentityServerDbContextInitialiser>();
